...
async function cropAndUpdateImage() {
    try {
        ...
        data.append('height', parseFloat(coordinates.height))
        data.append('width', parseFloat(coordinates.width))
        data.append('top', parseFloat(coordinates.top))
        data.append('left', parseFloat(coordinates.left))
