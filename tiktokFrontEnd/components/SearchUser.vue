...
<!-- above code is all right  -->

<!-- after infinit scroll  -->
<!-- <script setup>
...
<!-- <template>
    <div :class="wrapperClass">
        <input v-model="searchStore.query" @input="searchStore.search" :placeholder="placeholder" :class="inputClass" />

        <div v-if="searchStore.showDropdown && searchStore.results.length">
            <ul>
                <li v-for="(result, index) in searchStore.results" :key="result.id" @click="emit('select', result)">
                    {{ result.name }}
                </li>
            </ul>
